...
@section('content')
            ...
            <div class="row d-flex flex-wrap align-items-center">
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="position-relative right-hero-color">
                        <img src="{{asset('front/assets/images/hero/right-image.svg')}}" class="img-fluid"> 
                    </div>          
                </div>
            </div>
        </div>
    ...
    <section class="service position-relative overflow-hidden">
        <div class="container position-relative">
            <img src="{{asset('front/assets/images/service/dot-shape.png')}}" class="shape position-absolute">
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xxl-8 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    <img src="{{asset('front/assets/images/our-service/our-service.svg')}}" class="img-fluid"> 
                </div>
        ...
        <div class="container position-relative" >
            <div class="portfolio-wrap">
                <div class="owl-carousel owl-theme portfolio-slider">
                        <div class="item"><a href="#"><img src="{{asset('front/assets/images/portfolio/Portfolio.jpg')}}" class="w-100"></a></div>
                        <div class="item"><a href="#"><img src="{{asset('front/assets/images/portfolio/Portfolio.jpg')}}" class="w-100"></a></div>
                        <div class="item"><a href="#"><img src="{{asset('front/assets/images/portfolio/Portfolio.jpg')}}" class="w-100"></a></div>
                        <div class="item"><a href="#"><img src="{{asset('front/assets/images/portfolio/Portfolio.jpg')}}" class="w-100"></a></div>
                        <div class="item"><a href="#"><img src="{{asset('front/assets/images/portfolio/Portfolio.jpg')}}" class="w-100"></a></div>
                        ...
                        <div class="item">
                            <div class="details position-relative">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="avtar-img rounded-circle overflow-hidden"><img src="{{asset('front/assets/images/contact/testimonial-image.png')}}" class="img-fluid"></div>
                                    <div class="name ps-3">
                ...
                <div class="row justify-content-center">
                    <div class="col-xx-8 col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                        ...
                        <ul class="d-flex flex-wrap align-items-center list-unstyled mb-0 pl-0 owl-carousel owl-theme trusted-logos">
                            <li class="text-center item"><a href="#"><img src="{{asset('front/assets/images/contact/google.svg')}}"></a></li>
                            <li class="text-center item"><a href="#"><img src="{{asset('front/assets/images/contact/microsoft.svg')}}"></a></li>
                            <li class="text-center item"><a href="#"><img src="{{asset('front/assets/images/contact/amazon.svg')}}"></a></li>
                            <li class="text-center item"><a href="#"><img src="{{asset('front/assets/images/contact/unique.svg')}}"></a></li>
                            <li class="text-center item"><a href="#"><img src="{{asset('front/assets/images/contact/google.svg')}}"></a></li>
                            <li class="text-center item"><a href="#"><img src="{{asset('front/assets/images/contact/microsoft.svg')}}"></a></li>
                            <li class="text-center item"><a href="#"><img src="{{asset('front/assets/images/contact/amazon.svg')}}"></a></li>
                            <li class="text-center item"><a href="#"><img src="{{asset('front/assets/images/contact/unique.svg')}}"></a></li>
